...
export default function AuditsPage() {
  ...
  const auditsPerPage = 5; // adjust as needed
  ...
  if (loading || authLoading) return <div className="p-6 text-white">Loading audits...</div>;
  if (!audits.length) return <div className="p-6 text-white">No audits found.</div>;
